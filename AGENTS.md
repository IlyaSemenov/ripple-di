...
- `overrides.ts` defines the `OverrideRunner` contract and owns reusable override layers.
...
- `tests/overrides.test.ts` covers override runners, their layers, and per-call isolation.
